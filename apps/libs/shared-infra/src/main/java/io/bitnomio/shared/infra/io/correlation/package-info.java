 ...
 * Key components:
 * <ul>
 *   <li>{@link io.bitnomio.shared.infra.io.correlation.CorrelationIdConstants} - Constants for header names and MDC keys</li>
 *   <li>{@link io.bitnomio.shared.infra.io.correlation.CorrelationIdHolder} - ThreadLocal storage for correlation IDs</li>
 *   <li>{@link io.bitnomio.shared.infra.io.correlation.CorrelationIdFilter} - Servlet filter to extract and set correlation IDs</li>
 *   <li>{@link io.bitnomio.shared.infra.io.correlation.CorrelationIdInterceptor} - RestTemplate interceptor to propagate correlation IDs</li>
 *   <li>{@link io.bitnomio.shared.infra.io.correlation.CorrelationIdConfiguration} - Spring configuration for correlation ID components</li>
 * </ul>
 * <p>
 * Usage:
 * <ol>
